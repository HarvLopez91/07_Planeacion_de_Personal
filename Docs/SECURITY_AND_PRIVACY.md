...
8. **Mantener `Data/Contratos_Kactus/` fuera de Git y con acceso restringido** por necesidad funcional. Sus copias historicas conservan la misma clasificacion de sensibilidad que los insumos vigentes; no deben compartirse mediante enlaces publicos ni resumirse con datos individuales en `Docs/`, `Specs/`, commits o pull requests.
