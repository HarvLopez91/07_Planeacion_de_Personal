...
| Fecha de última actualización de este roadmap | 2026-08-03 |
...
| DATA-011 | Gobierno y organización de fuentes de contratos Kactus | Datos / Gobierno | Media | En validación | Confirmación de archivo oficial, URL corporativa y consumidores Power BI | Validar archivo oficial en `Fuente_Oficial/`, confirmar origen Microsoft 365 y auditar si existe o se requiere una consulta Power Query | Estructura física verificada, `Data/` excluido de Git, archivo oficial identificado, origen corporativo confirmado, proceso mensual documentado, consumidores identificados e histórico excluido del procesamiento activo | `Docs/ESTRUCTURA_PROYECTO.md`, `Docs/DATA_PIPELINE.md`, `Docs/RUNBOOK.md`, `Docs/SECURITY_AND_PRIVACY.md` |
